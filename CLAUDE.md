...
This project is indexed by GitNexus as **label-sync** (5003 symbols, 12322 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
